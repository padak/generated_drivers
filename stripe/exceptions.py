"""
Stripe Driver - Exception Hierarchy

Structured exceptions for agent understanding and error handling.
All exceptions include actionable error messages and structured details.
"""
